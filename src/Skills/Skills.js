    ...
    <div className="Skills section" id="Skills">
      ...
      <div className="divide grid gap-2">
        <div className="grid gap-2">
          <div>
            <h2 class="font-bold text-xl">Core</h2>
            <p>JavaScript</p>
            <p>HTML5</p>
            <p>CSS</p>
            <p>TypeScript</p>
          ...
          <div>
            <h2 class="font-bold text-xl">Libraries</h2>
            <p>Redux</p>
            <p>Jquery</p>
            <p>Bootstrap</p>
          </div>
          <div>
            <h2 class="font-bold text-xl">Elixir stack</h2>
            <p>Elixir</p>
            <p>Phoenix</p>
            <p>Liveview</p>
            <p>Ecto</p>
        ...
        <div className="grid gap-2">
          ...
          <div>
            <h2 class="font-bold text-xl">Database</h2>
            <p>MySQL</p>
          </div>
          <div>
            <h2 class="font-bold text-xl">AWS</h2>
            <p>EC2</p>
            <p>S3</p>
            <p>lambda</p>
            <p>Route53</p>
          ...
          <div>
            <h2 class="font-bold text-xl">Others</h2>
